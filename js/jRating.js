...
(function($) {
	$.fn.jRating = function(op) {
		var defaults = {
			/** String vars **/
			bigStarsPath : '/misc/icons/stars.png', // path of the icon stars.png
			smallStarsPath : '/misc/icons/small.png', // path of the icon small.png
			phpPath : '../save_rating', // path of the php file jRating.php
